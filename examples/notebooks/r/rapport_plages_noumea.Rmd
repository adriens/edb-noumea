...
author: "Adrien SALES / @rastadidi / dev.to/adriens"
...
\begin{abstract}
Ce rapport présente une synthèse claire et visuelle de la qualité des eaux de baignade à Nouméa, 
asée sur les derniers relevés disponibles.
Il propose une vue d’ensemble du statut sanitaire officiel des plages, ainsi que des analyses
détaillées des concentrations en bactéries E. coli et Enterocoques par point de prélèvement.

\textbf{L’objectif est d’informer efficacement les usagers sur les zones de baignade les plus sûres
et d’identifier rapidement les situations à risque à l'aide d'Open Data.}
\end{abstract}
...
La qualité de l'eau est évaluée en fonction de la concentration en bactéries E. coli (exprimée en UFC/100ml).
...
Le tableau ci-dessous présente le statut sanitaire officiel de chaque plage, tel qu'extrait de la base de données.
...
Ces ressources permettent d'explorer, d'analyser et de réutiliser les données de qualité des eaux de baignade à Nouméa.
