...
\begin{center}
{\bfseries\fontsize{22}{26}\selectfont SURVEILLANCE DE LA QUALITÉ DES EAUX DE BAIGNADE DE LA BAIE DES CITRONS - NOUMEA}
\end{center}
...
\begin{itemize}
	...
	\item[\textcolor{yellow}{\fontsize{12}{14}\selectfont $\blacktriangleright$}] Jaune : MOYENNE (baignade déconseillée)
...
knitr::asis_output(paste0(
  ...
  '{\\footnotesize',
  '\\begin{itemize}',
	'  \\item \\textbf{SATISFAISANTE} (E. coli $\\leq$ 500 NPP/100ml et Entérocoques $\\leq$ 100 NPP/100ml)',
  '  \\item \\textbf{MOYENNE} (E. coli $\\leq$ 1000 NPP/100ml et Entérocoques $\\leq$ 200 NPP/100ml)',
  '  \\item \\textbf{NON SATISFAISANTE} (E. coli $>$ 1000 NPP/100ml ou Entérocoques $>$ 200 NPP/100ml)',
  '\\end{itemize}',
  '\\vspace{1em}',
 '\\begin{center}\\footnotesize{\\href{https://github.com/adriens/edb-noumea}{https://github.com/adriens/edb-noumea}} \\textbf{𝕏}~\\href{https://x.com/rastadidi}{x.com/rastadidi}\\end{center}',
  '}'
))
