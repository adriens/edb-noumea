...
\begin{itemize}
	\item[\textcolor{blue}{\fontsize{1}{1}\selectfont $\blacktriangleright$}] Bleu : SATISFAISANTE
	\item[\textcolor{yellow}{\fontsize{1}{1}\selectfont $\blacktriangleright$}] Jaune : MOYENNE (baignade déconseillée)
	\item[\textcolor{red}{\fontsize{1}{1}\selectfont $\blacktriangleright$}] Rouge : NON SATISFAISANTE (baignade interdite)
\end{itemize}
